...
with(dat, {
  ...
  #plot3
  plot(datetime,Global_active_power,ylim=yscale,xlab = "", ylab = "Energy sub metering", type="n")
  lines(datetime,Sub_metering_1,ylim=yscale, col = "black", type = "l")
  lines(datetime,Sub_metering_2,ylim=yscale, col = "red", type = "l")
  lines(datetime,Sub_metering_3,ylim=yscale, col = "blue", type = "l")
